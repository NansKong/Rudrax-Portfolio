    ...
    return (
        <div className="space-y-6">
            <p className="text-lg leading-relaxed text-gray-300">
                I’m an AI and Python developer who enjoys building intelligent systems that actually work outside of research papers and notebooks.
            </p>
            ...
            <p className="text-base leading-relaxed text-gray-400">
                At the end of the day, I’m someone who likes learning fast, solving hard problems with code, and building things that actually get used.
            </p>
...
function LandingPage() {
    ...
    useEffect(() => {
        if (location.hash) {
            ...
            // Short timeout ensures the DOM has painted the sections
            setTimeout(() => {
                ...
                <div style={{ position: 'relative' }}>
                    <div style={{ position: 'relative', overflow: 'hidden', minHeight: '100vh' }}>
                        <Section
                            ...
                            className="min-h-screen flex items-center"
                        >
                            <div className="relative z-10 w-full max-w-6xl mx-auto px-6 lg:px-12 pb-16 md:pb-36 pt-16 md:pt-0">
